...
const SummaryStatistics = () => {
  return (
    <div className='flex flex-col pt-2 pb-4 px-4 bg-white shadow rounded-lg drop-shadow-md'>
      <div className='mb-2'>
        <p className='text-lg font-semibold  text-gray-800'>Statistics</p>
      </div>
      <div className='grid grid-cols-2 gap-4 sm:flex sm:items-center sm:justify-around'>
        <div className='flex items-center'>
          ...
          <div className='pl-4'>
            ...
            <p className='text-xs leading-3 text-gray-500 pt-2'>Sales</p>
          </div>
        </div>
        <div className='flex items-center'>
          ...
          <div className='pl-4'>
            ...
            <p className='text-xs leading-3 text-gray-500 pt-2'>Customers</p>
          </div>
        </div>
        <div className='flex items-center'>
          ...
          <div className='pl-4'>
            ...
            <p className='text-xs leading-3 text-gray-500 pt-2'>Products</p>
          </div>
        </div>
        <div className='flex items-center'>
          ...
          <div className='pl-4'>
            ...
            <p className='text-xs leading-3 text-gray-500 pt-2'>Revenue</p>
          </div>
        </div>
      </div>
    </div>
