...
const DeleteActivityModal = (props) => {
  const { open, setOpen, activity, setActivity, fetchActivities } = props;
  ...
  const deleteActivity = async () => {
    ...
    if (data) {
      toast.success(`Actividad ${name} eliminada`);
      setOpen(false);
      setActivity(null);
      fetchActivities();
    }
                  ...
                  <div className='mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left'>
                    ...
                    <div className='mt-2'>
                      <p className='text-sm text-gray-500'>
                        Estás seguro que desea eliminar esta actividad? Todos
                        los datos serán eliminados permanentemente. Esta acción
