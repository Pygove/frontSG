...
import { createProviderSchema } from '../../utils/schemas/provider.schema';
import { MyTextInput } from '../../components/Forms/Inputs';

const crumb = [HomeRoute, ProvidersRoute, NewProviderRoute];
      ...
      <div className='flex flex-col bg-white rounded-lg pt-3 drop-shadow-md'>
        <Formik
          ...
          onSubmit={async (values, { setSubmitting, resetForm }) => {
            ...
            console.log(values);
            try {
              const res = await providersService.create(values);
              toast.dismiss(loadingToast);
              toast.success(`Proveedor ${res.name} creado correctamente`);
              navigate('/proveedores/ver-proveedor/' + res.id);
            } catch (error) {
              setSubmitting(false);
              toast.dismiss(loadingToast);
                ...
                <div className='col-span-2 sm:col-span-3 grid grid-cols-3 gap-3'>
                  ...
                  <div className='col-span-3 sm:col-span-1'>
                    ...
                    >
                      ...
                      <option value='Op3'>Tarjeta de debito</option>
                      <option value='Op4'>Tarjeta de credito</option>
                    </Field>
                  </div>
