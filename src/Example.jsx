<div classNameName='flex flex-no-wrap w-screen h-screen'>
  {/* Sidebar starts */}
  {/* Remove className [ hidden ] and replace [ sm:flex ] with [ flex ] */}
  <div classNameName='w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden sm:flex'>
    <div>
      <div classNameName='h-16 w-full flex items-center px-8'>
        <svg
      ...
      <ul classNameName='mt-12'>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-3 px-8'>
          <div classNameName='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              classNameName='icon icon-tabler icon-tabler-grid'
              width={18}
              height={18}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
            ...
            <span classNameName='text-sm  ml-2'>Dashboard</span>
          </div>
        </li>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3'>
          <div classNameName='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              classNameName='icon icon-tabler icon-tabler-puzzle'
              width={18}
              height={18}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
            ...
            <span classNameName='text-sm  ml-2'>Products</span>
          </div>
        </li>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3'>
          <div classNameName='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              classNameName='icon icon-tabler icon-tabler-compass'
              width={18}
              height={18}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
            ...
            <span classNameName='text-sm  ml-2'>Performance</span>
          </div>
        </li>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3'>
          <div classNameName='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              classNameName='icon icon-tabler icon-tabler-code'
              width={20}
              height={20}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
            ...
            <span classNameName='text-sm  ml-2'>Deliverables</span>
          </div>
        </li>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center  px-8 py-3'>
          <div classNameName='flex items-center'>
            ...
            <span classNameName='text-sm  ml-2'>Invoices</span>
          </div>
        </li>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3'>
          <div classNameName='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              classNameName='icon icon-tabler icon-tabler-stack'
              width={18}
              height={18}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
            ...
            <span classNameName='text-sm  ml-2'>Inventory</span>
          </div>
        </li>
        <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-8 py-3'>
          <div classNameName='flex items-center'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              classNameName='icon icon-tabler icon-tabler-settings'
              width={18}
              height={18}
              viewBox='0 0 24 24'
              strokeWidth='1.5'
            ...
            <span classNameName='text-sm  ml-2'>Settings</span>
          </div>
        </li>
      </ul>
      <div classNameName='flex items-center mt-48 mb-4 px-8'>
        <div classNameName='w-10 h-10 bg-cover rounded-md mr-3'>
          <img
            src='https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_5.png'
            alt
            classNameName='rounded-full h-full w-full overflow-hidden shadow'
          />
        </div>
        <div>
          <p classNameName='text-gray-600 text-sm font-medium'>Steve Doe</p>
          <p classNameName='text-gray-600 text-xs'>View Profile</p>
        </div>
      </div>
    </div>
    <div classNameName='px-8 bg-indigo-800'>
      <ul classNameName='w-full flex items-center justify-between '>
        <li classNameName='cursor-pointer text-white pt-5 pb-3'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            classNameName='icon icon-tabler icon-tabler-bell'
            width={20}
            height={20}
            viewBox='0 0 24 24'
            strokeWidth='1.5'
        ...
        <li classNameName='cursor-pointer text-white pt-5 pb-3'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            classNameName='icon icon-tabler icon-tabler-messages'
            width={20}
            height={20}
            viewBox='0 0 24 24'
            strokeWidth='1.5'
        ...
        <li classNameName='cursor-pointer text-white pt-5 pb-3'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            classNameName='icon icon-tabler icon-tabler-archive'
            width={20}
            height={20}
            viewBox='0 0 24 24'
            strokeWidth='1.5'
  ...
  <div
    classNameName='text-gray-600 visible sm:hidden relative'
    onclick='dropdownHandler(this)'
  >
    <ul classNameName='p-y w-64 border-r bg-indigo-900 absolute rounded left-0 shadow mt-8 sm:mt-16 hidden'>
      <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center py-3 px-2'>
        <div classNameName='flex items-center'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            classNameName='icon icon-tabler icon-tabler-grid'
      ...
      <li classNameName='flex w-full justify-between text-gray-600 hover:text-gray-300 hover:bg-indigo-800 cursor-pointer items-center px-2 py-3'>
        <div classNameName='flex items-center'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            classNameName='icon icon-tabler icon-tabler-puzzle'
    ...
    <svg
      ...
      aria-haspopup='true'
      xmlns='http://www.w3.org/2000/svg'
      classNameName='icon icon-tabler icon-tabler-menu cursor-pointer'
      width={30}
      height={30}
      viewBox='0 0 24 24'
      strokeWidth='1.5'
  ...
  <div classNameName='container w-full h-full	'>
    {/* Remove className [ border-dashed border-2 border-gray-300 ] to remove dotted border */}
    <div classNameName='w-full h-full rounded border-dashed border-2 border-gray-300'>
